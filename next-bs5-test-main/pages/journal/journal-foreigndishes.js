...
// data
import bigbite from '@/data/product/異國料理/ForeignDishes_data.json'
import { entries } from 'lodash'

export default function JournalForeignDishes({ onSelectItem }) {
        ...
        return (
          <div className="col" key={`${v.name}-${i}`}>
            ...
            <div className="card-body">
              ...
              <span>{v.calories}, 蛋白質:{v.protein}</span>
            </div>
          </div>
        )
      })}
